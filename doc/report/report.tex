...
In our logs \ref{listing:6-2-tux33-pic2.pcapng}, \ref{listing:6-5-tux32} we were unable to detect any influence of the congestion control mechanism, since in all connections the throughput instantly grew to ?, at which point it plateaued until the connection was closed or another download was started (see graphs TODO).
