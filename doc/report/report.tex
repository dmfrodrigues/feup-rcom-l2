...
In our logs we verified that the receiver buffer nerver overflowed, thus never occuring a congestion followed by a timeout.
This could have happened because the server was not sending data fast enough, limiting the client window that stabilized very fast.
