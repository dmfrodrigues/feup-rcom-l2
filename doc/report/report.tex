...
\begin{center}
    \small
    \begin{tabular}{@{}l | p{53mm} | l@{}}
        {\normalfont\textbf{Dev.}} & {\normalfont\textbf{Description}} & {\normalfont\textbf{Commands}} \\ \hline
        router & Configure interface with VLAN31 & \begin{lstlisting}[basicstyle=\linespread{0.85}\ttfamily\small, frame=none, numbers=none, language=cisco]
interface gigabitethernet 0/0
ip address 172.16.31.254 255.255.255.0
no shutdown
        \end{lstlisting} \\ \hline
        router & Configure interface with lab router & \begin{lstlisting}[basicstyle=\linespread{0.85}\ttfamily\small, frame=none, numbers=none, language=cisco]
interface gigabitethernet 0/1
ip address 172.16.1.39 255.255.255.0
no shutdown 
        \end{lstlisting} \\
        router & Add route to VLAN30 via tux34 & \begin{lstlisting}[basicstyle=\linespread{0.85}\ttfamily\small, frame=none, numbers=none, language=cisco]
...
\begin{center}
    \small
    \begin{tabular}{@{}p{10mm} | p{33mm} | p{108mm}@{}}
        {\normalfont\textbf{Dev.}} & {\normalfont\textbf{Description}} & {\normalfont\textbf{Commands}}  \\ \hline
...
\begin{figure}[H]
    ...
    \end{tikzpicture}
	\caption{Network architecture for experiment 6}
	\label{fig:network_exp6}
\end{figure}
