...
This method sends ACK (acknowlegdment message), when the data is received successfully before a timeout occurs, and a acknowlegdment number indicating the next byte expected.
